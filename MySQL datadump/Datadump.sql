CREATE DATABASE  IF NOT EXISTS `InventoryApp` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `InventoryApp`;
...
CREATE TABLE `ELECTRICAL` (
  ...
  CONSTRAINT `ToolID` FOREIGN KEY (`ToolID`) REFERENCES `TOOL` (`ToolID`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ELECTRICAL` VALUES (1020,'AC'),(1021,'AC'),(1022,'AC'),(1023,'AC'),(1024,'AC'),(1025,'AC'),(1026,'AC'),(1027,'AC'),(1028,'AC'),(1029,'AC'),(1030,'DC'),(1031,'DC'),(1032,'DC'),(1033,'DC'),(1034,'DC'),(1035,'DC'),(1036,'DC'),(1037,'DC'),(1038,'DC'),(1039,'DC'),(1040,'DC'),(1050,'AC'),(5000,'AC');
...
CREATE TABLE `INTERNATIONAL` (
  ...
  CONSTRAINT `Supplier_ID` FOREIGN KEY (`Supplier_ID`) REFERENCES `SUPPLIER` (`SupplierID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ORDERLINE` (
  ...
  CONSTRAINT `Sup_ID` FOREIGN KEY (`Sup_ID`) REFERENCES `SUPPLIER` (`SupplierID`),
  CONSTRAINT `Tool_ID` FOREIGN KEY (`Tool_ID`) REFERENCES `TOOL` (`ToolID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ORDERLINE` VALUES (1000,1005,8012,1512),(10000,1001,8004,41),(10000,1002,8001,34),(10000,1003,8020,39),(10000,1004,8003,42),(10000,1005,8012,1523),(10000,1009,8006,38),(10000,1011,8011,16),(10000,1023,8014,37),(10000,5000,8001,15);
...
INSERT INTO `ORDERS` VALUES (1000,'2020-11-24'),(10000,'2020-11-25');
...
CREATE TABLE `PURCHASES` (
  ...
  KEY `Tool_idx` (`Tool`),
  CONSTRAINT `Cust_id` FOREIGN KEY (`Cust_id`) REFERENCES `CLIENT` (`Customer_ID`),
  CONSTRAINT `Tool` FOREIGN KEY (`Tool`) REFERENCES `TOOL` (`ToolID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `TOOL` (
  ...
  CONSTRAINT `SupplierID` FOREIGN KEY (`SupplierID`) REFERENCES `SUPPLIER` (`SupplierID`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `TOOL_AFTER_UPDATE` AFTER UPDATE ON `tool` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `add_orderline` AFTER UPDATE ON `tool` FOR EACH ROW BEGIN
...
-- Dump completed on 2020-11-26  8:54:48
